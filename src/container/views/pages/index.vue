<template>
  <div class="flux-container">
      ...
      <div class = "containEnd  flex-center" :style = "document_contain">
...
export default {
  computed: {
    document_cb () {
      if(!this.document) return "width:60%;  "
      else return ""
    },
    document_contain () {
      if(!this.document) return "width:100%; height:100%; right: 0; "
      else return ""
    },
    document_cb_class () {
