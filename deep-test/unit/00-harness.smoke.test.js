...
describe("deep-test harness", () => {
    it("installs framework globals", () => {
        expect(typeof globalThis.checkout).toBe("function");
        expect(globalThis.checkout(undefined, "fallback")).toBe("fallback");
        expect(globalThis.checkout("value", "fallback")).toBe("value");
        expect(typeof globalThis.Logger).toBeDefined();
    });
